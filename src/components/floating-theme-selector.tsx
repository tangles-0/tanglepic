...
function ThemeIcon({ theme }: { theme: string }) {
  ...
  switch (theme) {
    case "default":
      return (
        <svg viewBox="0 0 24 24" width={size} height={size} fill="none" stroke={iconColor} strokeWidth="2">
          <path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z" />
        </svg>
      );
    case "dark":
      return (
        <svg viewBox="0 0 24 24" width={size} height={size} fill="none" stroke={iconColor} strokeWidth="2" strokeLinecap="round">
          <circle cx="12" cy="12" r="5" />
          <path d="M12 1v3M12 20v3M3 12h3M18 12h3M5.64 5.64l2.12 2.12M16.24 16.24l2.12 2.12M5.64 18.36l2.12-2.12M16.24 7.76l2.12-2.12" />
        </svg>
      );
    case "author":
      return (
    ...
    case "cyber":
      return (
        <svg viewBox="0 0 24 24" width={size} height={size} fill="none" stroke={iconColor} strokeWidth="1.5">
          <rect x="3" y="3" width="18" height="18" rx="2" />
          <path d="M3 9h18M3 15h18M9 3v18M15 3v18" />
          <circle cx="6" cy="6" r="1" fill={iconColor} />
          <circle cx="18" cy="6" r="1" fill={iconColor} />
          <circle cx="6" cy="18" r="1" fill={iconColor} />
          <circle cx="18" cy="18" r="1" fill={iconColor} />
        </svg>
      );
    case "blood":
      return (
    ...
    case "neon-green":
      return (
        <svg viewBox="0 0 640 512" width={size} height={size} fill={iconColor} stroke={iconColor} strokeWidth="6">
          ...
          <div className="py-1">
            {THEMES.map((option) => (
              <button
                ...
                disabled={isSaving}
                className={`floating-theme-option flex w-full items-center gap-3 px-4 py-2 text-left text-xs transition ${
